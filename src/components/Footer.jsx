    ...
    <div className=' relative flex w-full h-screen bg-zinc-900 p-20'>
        <div className=' flex h-full flex-col justify-between w-1/2'>
           <div className='Heading'>
            <h1 className='text-[7vw] font-semibold leading-none -mb-6'>EYE-</h1>
            <h1 className='text-[7vw] font-semibold leading-none -mb-6'>OPENING</h1>
           </div>
        ...
        <div className='w-1/2 h-full'>
          <h1 className='text-[6vw] font-semibold leading-none tracking-tighter'>PRESENTATIONS</h1>
          <div className='mt-[50px]'>
            <h1 className=''>Social Media</h1>
            <div className='flex flex-col mt-[20px] gap-1.5 underline'>
              <a href="">Instagram</a>
              <a href="">Facebook</a>
              <a href="">Linkedin</a>
              <a href="">Behance</a>
        ...
        <div className='flex gap-80'>
          <div className='mt-[50px]'>
            ...
            <div className='flex flex-col mt-[20px] gap-1.5 underline'>
              <a href="">work.yashkamdar@gmail.com</a>
            </div>
          </div>
        ...
        <div className=''>
            ...
            <div className='flex flex-col mt-[20px] gap-1.5 underline'>
              <a href="https://ochi.design/">https://ochi.design/</a>
            </div>
          </div>
